DECLARE @RELATORIO_FABIO2 TABLE(
...
INSERT INTO @RELATORIO_FABIO2 (CODIGO_PN,NOME_FANTASIA,CIDADE,ESTADO
...
AND T2.QryGroup5 ='Y'
AND T2.QryGroup14 ='N'
AND T0.ITEMCODE IN ('RE00008','RE00020','RE00026','RE00032','RE00038','RE00044','RE00057','RE00061','RE00066','RE00076','RE00084','RE00093','RE00155','RE00229','RE00233','RE00106')--,'RE00227'
) 
SELECT  DISTINCT
		 R0.ITEMNAME
		,CASE WHEN R0.ITEMNAME = 	'O Brilho da Inteligencia Kit - Aluno - Parte 2'	OR R0.ITEMNAME = 'O Brilho da Inteligencia - Aluno - Parte 2'			THEN	'3 anos EI'
			  WHEN R0.ITEMNAME = 	'Ciranda da Inteligencia Aluno liçao 8'						THEN	'4 anos EI'
			  WHEN R0.ITEMNAME = 	'Jogos da Inteligencia Aluno liçao 8'						THEN	'5 anos EI'
			  WHEN R0.ITEMNAME = 	'Olimpiada da Inteligencia Aluno parte 2'					THEN	'1° ano EFI'
			  WHEN R0.ITEMNAME = 	'Inteligencia Saudavel Aluno parte 2'						THEN	'2° ano EFI'
		  	  WHEN R0.ITEMNAME = 	'Relaçoes Saudaveis Aluno parte 2'							THEN	'3° ano EFI'
			  WHEN R0.ITEMNAME = 	'Cidade da Memoria Aluno parte 2'							THEN	'4° ano EFI'
			  WHEN R0.ITEMNAME = 	'Armadilhas da Mente Aluno liçao 8'							THEN	'5 °ano EFI'
			  WHEN R0.ITEMNAME = 	'Mentes Brilhantes Aluno parte 2'							THEN	'6° ano EFII'
			  WHEN R0.ITEMNAME = 	'Codigos da Inteligencia Aluno parte 2'						THEN	'7° ano EFII'
			  WHEN R0.ITEMNAME = 	'EU no Comando da Mente Aluno parte 2'						THEN	'8° ano EFII'
			  WHEN R0.ITEMNAME = 	'Ser Humano Sem Fronteiras Aluno liçao 7'					THEN	'9° ano EFII'
			  WHEN R0.ITEMNAME = 	'Identidade A Liderança do EU Aluno liçao 7'				THEN	'1° ano EM'
			  WHEN R0.ITEMNAME = 	'Eu em Cena - Aluno - Parte 2'								THEN	'2° ano EM'
			  WHEN R0.ITEMNAME = 	'Gestao da Emocao Vestibular e Profissao Aluno Parte 2'		THEN	'3° ano EM'
			  WHEN R0.ITEMNAME = 	'Praxis As Marcas do EU Aluno Parte 2'						THEN	'Familia'

		 END SEGMENTO
		,'QTD_KIT' = (SELECT COUNT (A.ITEMNAME) FROM @RELATORIO_FABIO2 A WHERE A.ITEMNAME =  R0.ITEMNAME)
		...
		FROM @RELATORIO_FABIO2 R0
	PIVOT(
		  SUM(R0.QTD_PENDENTE) FOR
			R0.ITEMCODE IN (RE00008,RE00020,RE00026,RE00032,RE00038,RE00044,RE00057,RE00061,RE00066,RE00076,RE00084,RE00093,RE00155,RE00229,RE00233,RE00106)
		) AS R0
