					...
					IF @PG_CODIGO_ITEM = (SELECT ITEMCODE FROM OITM WHERE ITEMCODE = @PG_CODIGO_ITEM AND QryGroup25 ='Y')
						BEGIN
							...
							DECLARE 
							 ...
							 END	
	/*inserir apos aval do rodrigo*/	    INSERT INTO PRODUTOS_GENIOS_ESCOLA (PG_NOME_CLIENTE,PG_NOMEF_CLIENTE,PG_CARDCODE,PG_CNPJ,PG_LOG,PG_RUA,PG_NUMERO,PG_BAIRRO,PG_CIDADE,PG_ESTADO,PG_CEP,PG_EMAIL,PG_DATA_NOTA,                                        PG_NUMERO_NOTA,PG_NUMERO_DOC,PG_NUMERO_DOC_BASE,PG_STATUS,PG_CANCELED) 
